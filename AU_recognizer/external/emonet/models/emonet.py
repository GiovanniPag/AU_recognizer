...
class ConvBlock(nn.Module):
    ...
    def forward(self, x):
        ...
        out1 = self.bn1(x)
        out1 = func.relu(out1, True)
        out1 = self.conv1(out1)

        out2 = self.bn2(out1)
        out2 = func.relu(out2, True)
        out2 = self.conv2(out2)

        out3 = self.bn3(out2)
        out3 = func.relu(out3, True)
...
class HourGlass(nn.Module):
    ...
    def _forward(self, level, inp):
        ...
        low1 = func.max_pool2d(inp, 2, stride=2)
        ...
        up2 = func.interpolate(low3, scale_factor=2, mode='nearest')
...
class EmoNet(nn.Module):
    def __init__(self, num_modules=2, n_expression=8, n_reg=2, n_blocks=4, attention=True, temporal_smoothing=False):
        ...
        self.emo_net_2 = None
        self.avg_pool_2 = None
        self.emo_fc_2 = None
        self.emo_parameters = None
        self.emo_modules = None
        self.temporal_state = None
        self.conv1x1_input_emo_2 = None
        self.emo_convs = None
        self.num_modules = num_modules
    ...
    def create_Emo(self):
        ...
        # Separate emotion parameters from FAN parameters
    ...
    def forward(self, x, reset_smoothing=False, intermediate_features=False):
        ...
        emo_feat_conv1_d = self.conv1x1_input_emo_2(emo_feat)
        final_features = self.emo_net_2(emo_feat_conv1_d)
