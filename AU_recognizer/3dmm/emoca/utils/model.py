...
from .DecaUtils import tensor2image, write_obj, upsample_mesh
from .lightning_logging import _fix_image
from .utility import get_path_to_models
...
def save_obj(emoca, filename, opdict, i=0):
    dense_template_path = get_path_to_models() / "DECA" / "data" / 'texture_data_256.npy'
    ...
    dense_vertices, dense_colors, dense_faces = upsample_mesh(vertices, normals, displacement_map, texture,
                                                              dense_template)
