...
def copy_parameter_from_resnet(model, resnet_dict):
    ...
    for name, param in list(resnet_dict.items())[0:None]:
        ...
        try:
            ...
            print(name, f' is inconsistent! {err}')
            continue
...
def load_ResNet50Model():
    ...
    copy_parameter_from_resnet(model, torchvision.models.
                               resnet50(weights=torchvision.models.ResNet50_Weights.DEFAULT).state_dict())
    return model
