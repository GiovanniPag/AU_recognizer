...
def locate_checkpoint(cfg, mode=None):
    ...
    if isinstance(mode, int):
        ...
        for idx, ckpt in enumerate(checkpoints):
            ...
            try:
                ...
                print(f"Unable to convert '{loss_str}' to float. Skipping this checkpoint.  {e}")
                continue
...
def get_checkpoint_with_kwargs(cfg, checkpoint_mode=None):
    checkpoint = get_checkpoint(cfg, checkpoint_mode=checkpoint_mode)
...
def get_checkpoint(cfg, checkpoint_mode=None):
    ...
    checkpoint = locate_checkpoint(cfg, mode=checkpoint_mode)
    return checkpoint
