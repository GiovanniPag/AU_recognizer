...
def theme():
    ...
    try:
        ...
        # In the Personalisation Key, get the AppsUseLightTheme subkey. This returns a tuple. The first item in the
        # tuple is the result we want (0 or 1 indicating Dark Mode or Light Mode); the other value is the type of
        # subkey e.g. DWORD, QWORD, String, etc.
