...
class CustomButton(CustomTKBaseClass):
    ...
    def __init__(self,
        ...
        # shape
        self._corner_radius: int = ThemeManager.theme["CustomButton"][
        ...
        self._draw_engine.set_round_to_even_numbers(self._round_width_to_even_numbers,
                                                    self._round_height_to_even_numbers)  # rendering options
    ...
    def _create_grid(self):
        ...
        # Outer rows and columns have weight of 1000 to overpower the rows and columns of the label and image
        # with weight 1.
