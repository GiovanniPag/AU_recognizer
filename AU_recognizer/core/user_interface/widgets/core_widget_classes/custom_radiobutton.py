...
class CustomRadioButton(CustomTKBaseClass):
    """
    ...
    def __init__(self,
        ...
        # color
        self._fg_color = ThemeManager.theme["CustomRadioButton"][
            "fg_color"] if fg_color is None else self._check_color_type(fg_color)
        self._hover_color = ThemeManager.theme["CustomRadioButton"][
            "hover_color"] if hover_color is None else self._check_color_type(hover_color)
        self._border_color = ThemeManager.theme["CustomRadioButton"][
            "border_color"] if border_color is None else self._check_color_type(border_color)

        # shape
        self._corner_radius = ThemeManager.theme["CustomRadioButton"][
            "corner_radius"] if corner_radius is None else corner_radius
        self._border_width_unchecked = ThemeManager.theme["CustomRadioButton"][
            "border_width_unchecked"] if border_width_unchecked is None else border_width_unchecked
        self._border_width_checked = ThemeManager.theme["CustomRadioButton"][
            "border_width_checked"] if border_width_checked is None else border_width_checked

        # text
        self._text = text
        self._text_label: Union[tkinter.Label, None] = None
        self._text_color = ThemeManager.theme["CustomRadioButton"][
            "text_color"] if text_color is None else self._check_color_type(text_color)
        self._text_color_disabled = ThemeManager.theme["CustomRadioButton"][
