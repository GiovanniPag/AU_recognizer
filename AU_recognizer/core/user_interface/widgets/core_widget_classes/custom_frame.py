...
class CustomFrame(CustomTKBaseClass):
    ...
    def __init__(self,
        ...
        if fg_color is None:
            if isinstance(self.master, CustomFrame):
                if self.master._fg_color == ThemeManager.theme["CustomFrame"]["fg_color"]:
    ...
    def configure(self, require_redraw=False, **kwargs):
        if "fg_color" in kwargs:
            ...
            require_redraw = True
            # check if widgets are children of the frame and change their bg_color to new frame fg_color
