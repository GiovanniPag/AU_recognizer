...
class CustomOptionMenu(CustomTKBaseClass):
    ...
    def __init__(self,
        ...
        if len(self._values) > 0:
            ...
            self._current_value = "CustomOptionMenu"
