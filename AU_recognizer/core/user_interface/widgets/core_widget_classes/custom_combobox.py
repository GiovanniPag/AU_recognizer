...
class CustomComboBox(CustomTKBaseClass):
    ...
    def __init__(self,
                 ...
                 dropdown_font: Optional[Union[tuple, CustomFont]] = None,
        ...
        if self._variable is None:
            if len(self._values) > 0:
                ...
                self._entry.insert(0, "CustomComboBox")
