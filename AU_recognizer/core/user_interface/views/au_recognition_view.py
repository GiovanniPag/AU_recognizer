...
from AU_recognizer.core.user_interface import CustomLabel, CustomButton
...
class AURecognitionView(View):
    def __init__(self, master=None):
        ...
        self._au_button: Optional[CustomButton] = None
        self._au_tag_label = StringVar()
        self._tag_button: Optional[CustomButton] = None
        self.update_language()

    def create_view(self):
        logger.debug("update view in AURecognition view")
        self._au_button = CustomButton(self, textvariable=self._au_button_label)
        self._au_button.grid(row=0, column=0, sticky="nsew")
        self._tag_button = CustomButton(self, textvariable=self._au_tag_label)
        self._tag_button.grid(row=1, column=0, sticky="nsew")
