...
from tkinter import BOTH, BOTTOM, X, RIGHT, END, TOP
...
from AU_recognizer.core.util import i18n, PA_NAME, logger, I18N_CLOSE_BUTTON, P_PATH, MODEL_FOLDER, CONFIG, nect_config, \
    MF_MODEL, F_OUTPUT, MF_FIT_MODE, MF_SAVE_MESH, MF_SAVE_IMAGES, MF_SAVE_CODES, ERROR_ICON
...
class FitDialog(Dialog):
    ...
    def run_fitting(self):
        try:
            ...
            dataset = TestData(self.images_to_fit, face_detector="fan", max_detection=20)
