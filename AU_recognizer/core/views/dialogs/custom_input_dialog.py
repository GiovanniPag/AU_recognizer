...
class CustomInputDialog(CustomToplevel):
    ...
    def __init__(self,
                 ...
                 title: str = "CustomInputDialog",
                 font: Optional[Union[tuple, CustomFont]] = None,
                 text: str = "CustomInputDialog"):
        super().__init__(fg_color=fg_color)

        self._fg_color = ThemeManager.theme["CustomToplevel"][
    ...
    def _create_widgets(self):
        ...
        self._label = CustomLabel(master=self,
                                  width=300,
                                  wraplength=300,
        ...
        self._entry = CustomEntry(master=self,
                                  width=230,
